...
public class HttpUtil {
    ...
    public static void getData(String uri, int page, MessengeString str, RequestParams params) {
        if (page != 0) {
    ...
    public static void handData(String bookid, MessengeString str) {
        sendData(HttpRequest.HttpMethod.GET, BooKDeInter.bookuri + bookid + BooKDeInter.bookadduri, null, new MyRequest(str));
    }
}
